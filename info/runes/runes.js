...
function runeInfo(rune){ //champ code name, NOT display name
	...
	html += '			<img src="/data/runeart/' + rune + '.png" class="img-polaroid" alt="" id="splash">'; //all art by Riot Games (tm)
	html += '		</a>';
	html += '	</div>';
	html += '</div>';
	//image is 480x480
	...
	html += '<div id="title">';
	//html += '	<h1 style="position:relative;top:-285px;left:400px;font-size:52pt">' + exports['champs'][chp]['display'] + '</h1>'; //rune name
	html += '</div>';
